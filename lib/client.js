...
var SHORTCUT_ACTIONS = ["open", "find", "reference"];
var SHORTCUT_LABELS = {
  open: "\u547C\u51FA\u5FEB\u901F\u6253\u5F00\u9762\u677F",
  find: "\u5728\u6587\u4EF6\u9884\u89C8\u91CC\u641C\u7D22\u5185\u5BB9",
...
var DEFAULT_SHORTCUT = DEFAULT_SHORTCUTS.open;
var SHORTCUTS_KEY = "dsh-quick-open:shortcuts";
var LEGACY_SHORTCUT_KEY = "dsh-quick-open:shortcut";
...
var NAMED_KEYS = /* @__PURE__ */ new Set(["enter", "space", "tab", "backspace", "delete", "home", "end"]);
...
function modifiersMatch(shortcut, event, mac = isMacPlatform()) {
...
function coerceShortcut(value) {
  if (typeof value !== "object" || value === null) return void 0;
  const record = value;
  const key = record.key;
  if (typeof key !== "string" || bindableKey(key) !== key) return void 0;
  const shortcut = {
    mod: record.mod === true,
  ...
  return validateShortcut(shortcut) === void 0 ? shortcut : void 0;
}
function readShortcuts() {
  ...
  try {
    ...
    if (raw !== null) {
      ...
      if (typeof parsed === "object" && parsed !== null) {
        ...
        for (const action of SHORTCUT_ACTIONS) {
          ...
          if (coerced !== void 0) out[action] = coerced;
        }
        return out;
      }
      return out;
    ...
    if (legacy !== null) {
      ...
      if (coerced !== void 0) out.open = coerced;
    }
    return out;
  } catch {
    return out;
...
function readShortcut(action = "open") {
...
function writeShortcut(shortcut, action = "open") {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: styles.footer, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
              describeShortcut(boundShortcuts.reference),
              " \u52A0\u5165\u5BF9\u8BDD\uFF08\u4E0D\u5173\u95ED\uFF09"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
              describeShortcut(boundShortcuts.open),
              " \u5F00\u5173"
            ] }),
...
function QuickOpenSettings({ ctx }) {
  ...
  const [shortcuts, setShortcuts] = (0, import_react2.useState)(() => readShortcuts());
  const [recording, setRecording] = (0, import_react2.useState)(null);
  const [shortcutError, setShortcutError] = (0, import_react2.useState)(null);
  const onRecorderKeyDown = (0, import_react2.useCallback)((event, action) => {
  ...
  const shortcutSection = /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: styles2.field, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: styles2.label, children: "\u5FEB\u6377\u952E" }),
    SHORTCUT_ACTIONS.map((action) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: 4, marginTop: 4 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: styles2.hint, children: SHORTCUT_LABELS[action] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "button",
          {
            type: "button",
            style: { ...styles2.button, ...recording === action ? styles2.buttonRecording : {} },
            onClick: () => setRecording(action),
            onBlur: () => setRecording((current) => current === action ? null : current),
            onKeyDown: (event) => onRecorderKeyDown(event, action),
            children: recording === action ? "\u6309\u4E0B\u65B0\u7684\u5FEB\u6377\u952E\u2026\uFF08Esc \u53D6\u6D88\uFF09" : describeShortcut(shortcuts[action], isMacPlatform())
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "button",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: styles2.hint, children: SHORTCUT_HINTS[action] })
    ] }, action)),
